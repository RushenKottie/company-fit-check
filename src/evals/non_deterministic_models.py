"""Data models for non-deterministic regression case files."""
...
class NonDeterministicRegressionCase(BaseModel):
    """One flat non-deterministic regression case definition."""
