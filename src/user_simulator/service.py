    ...
    def _build_reply_messages(
        ...
        system_message = SystemMessage(
            content=(
                ...
                "2. Use the initial user prompt as the main grounding source for facts, "
                "priorities, implied constraints, and tone of voice.\n"
                ...
                "the initial prompt or provided case data, avoid guessing.\n"
                "6. If the agent asks for a detail that is already stated or strongly "
                "implied by the initial prompt or case data, say that directly and "
                "restate only the grounded fact that answers it.\n"
